...
export const metadata: Metadata = {
  ...
  alternates: { canonical: `${site.url}/blog/quotazione-oro-fiscalita-lingotti-italia` },
};

export default function BlogPostPage() {
  const post = blogPosts.find((p) => p.slug === 'quotazione-oro-fiscalita-lingotti-italia');
  ...
  const articleJsonLd = {
    ...
    mainEntityOfPage: `${site.url}/blog/quotazione-oro-fiscalita-lingotti-italia`,
  };
        ...
        <div className="container-x max-w-4xl">
          <div className="bg-white rounded-2xl border border-ink-900/10 p-8 md:p-12 shadow-sm">
            <ContactForm
              ...
              source="blog:quotazione-oro-fiscalita-lingotti-italia"
            />
          </div>
        </div>
      </Section>
