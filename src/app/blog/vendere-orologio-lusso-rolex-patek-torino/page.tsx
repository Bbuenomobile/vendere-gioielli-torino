...
export const metadata: Metadata = {
  ...
  alternates: { canonical: `${site.url}/blog/vendere-orologio-lusso-rolex-patek-torino` },
};

export default function BlogPostPage() {
  const post = blogPosts.find((p) => p.slug === 'vendere-orologio-lusso-rolex-patek-torino');
  ...
  const articleJsonLd = {
    ...
    mainEntityOfPage: `${site.url}/blog/vendere-orologio-lusso-rolex-patek-torino`,
  };
        ...
        <div className="container-x max-w-4xl">
          <div className="bg-white rounded-2xl border border-ink-900/10 p-8 md:p-12 shadow-sm">
            <ContactForm
              ...
              source="blog:vendere-orologio-lusso-rolex-patek-torino"
            />
          </div>
        </div>
      </Section>
