...
export const metadata: Metadata = {
  ...
  alternates: { canonical: `${site.url}/blog/valore-gioielli-firmati-cartier-bulgari-torino` },
};

export default function BlogPostPage() {
  const post = blogPosts.find((p) => p.slug === 'valore-gioielli-firmati-cartier-bulgari-torino');
  ...
  const articleJsonLd = {
    ...
    mainEntityOfPage: `${site.url}/blog/valore-gioielli-firmati-cartier-bulgari-torino`,
  };
        ...
        <div className="container-x max-w-4xl">
          <div className="bg-white rounded-2xl border border-ink-900/10 p-8 md:p-12 shadow-sm">
            <ContactForm
              ...
              source="blog:valore-gioielli-firmati-cartier-bulgari-torino"
            />
          </div>
        </div>
      </Section>
