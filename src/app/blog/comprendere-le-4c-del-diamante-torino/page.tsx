...
export const metadata: Metadata = {
  ...
  alternates: { canonical: `${site.url}/blog/comprendere-le-4c-del-diamante-torino` },
};

export default function BlogPostPage() {
  const post = blogPosts.find((p) => p.slug === 'comprendere-le-4c-del-diamante-torino');
  ...
  const articleJsonLd = {
    ...
    mainEntityOfPage: `${site.url}/blog/comprendere-le-4c-del-diamante-torino`,
  };
        ...
        <div className="container-x max-w-4xl">
          <div className="bg-white rounded-2xl border border-ink-900/10 p-8 md:p-12 shadow-sm">
            <ContactForm
              ...
              source="blog:comprendere-le-4c-del-diamante-torino"
            />
          </div>
        </div>
      </Section>
